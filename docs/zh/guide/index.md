...
::: note
由于 Scala 插件中提供的 `openapi` 变化过于频繁，Scala 不再作为默认支持选项。需要在 Scala 项目中使用的开发者可自行从 [easy-yapi/releases](https://github.com/tangcent/easy-yapi/releases) 获得支持 Scala 的插件包。
:::
