window.ydoc_plugin_search_json = {
  "文档": [
    ...
    {
      "title": "Call(类Postman)",
      "content": "打开项目中的包含api的文件, 右键文件内容选择选择Call Api, 即可通过窗口进行api请求\n可以自行配置快捷键\n可以通过相关配置实现自动登录\nCall相关规则\n\n    规则的key\n规则目标(上下文)\n版本\n规则描述\n\n\n\n\n    http.call.before\nrequest\nv1.9.0+\nhttp请求前回调\n\n\n    http.call.after\nrequest&response\nv1.9.0+\nhttp请求后回调\n\n\n点击规则配置查看更多.",
      ...
      "children": [
        {
          ...
          "content": "demo增加logapi.class.parse.before=groovy:logger.info(\"开始解析类:\"+it.name())"
        }
      ]
    },
    {
      ...
      "children": [
        {
          ...
          "content": "demo增加logapi.class.parse.after=groovy:logger.info(\"类:\"+it.name()+\"解析完成\")"
        }
      ]
    },
    {
  ...
  "框架支持": [
      ...
      "children": [
        {
          ...
          "content": "javax.validation简单-不分组\n简单-分组\n完全-不分组\n完全-分组\n"
        }
      ]
    },
    {
      "title": "",
      "content": "",
      "url": "/framwork/javax_validation_simple.html",
      "children": [
        {
          "title": "在推荐配置中有部分javax.validation相关的简单配置",
          "url": "/framwork/javax_validation_simple.html#在推荐配置中有部分javax.validation相关的简单配置",
          "content": "在推荐配置中有部分javax.validation相关的简单配置默认选择的就是不分组模式javax.validation\n可以在 Preferences(Settings) > Other Settings > EasyApi >Recommend 中检查是否有勾选javax.validation, 并移除勾选javax.validation(grouped)\n"
        }
      ]
    },
    {
      "title": "",
      "content": "",
      "url": "/framwork/javax_validation_simple_group.html",
      "children": [
        {
          "title": "在推荐配置中有部分javax.validation相关的简单配置",
          "url": "/framwork/javax_validation_simple_group.html#在推荐配置中有部分javax.validation相关的简单配置",
          "content": "在推荐配置中有部分javax.validation相关的简单配置默认选择的是不分组模式javax.validation\n如果需要开启分组校验, 可以在 Preferences(Settings) > Other Settings > EasyApi >Recommend 中移除勾选javax.validation, 勾选javax.validation(grouped)\n"
        }
      ]
    },
    {
    ...
    },
    {
      "title": "",
      "content": "",
      "url": "/framwork/javax_validation_ultimate_group.html",
      "children": [
        {
          "title": "WIP",
          "url": "/framwork/javax_validation_ultimate_group.html#wip",
          "content": "WIP"
        }
      ]
    },
  ...
  "QA": [
    {
      ...
      "children": [
        ...
        },
        {
          ...
          "url": "/qa/index.html#导出时出现com.xxx.xxx-is-to-complex.-blocked-cause-by-xxx-reached-xxx,-如何处理",
