      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'field.type', link: '/settings/rules/field_type' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'enum.use.by.type', link: '/settings/rules/enum_use_by_type' },
            { text: 'enum.use.ordinal', link: '/settings/rules/enum_use_ordinal' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'json.rule.enum.convert', link: '/settings/rules/json_rule_enum_convert' },
