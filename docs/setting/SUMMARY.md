...
* [可用配置规则](config-rule.md)
    ...
    * [&nbsp;&nbsp;&nbsp;&nbsp;class.is.feign.ctrl](rules/class_is_feign_ctrl.md)
    * [&nbsp;&nbsp;&nbsp;&nbsp;class.is.jaxrs.ctrl](rules/class_is_jaxrs_ctrl.md)
    * [&nbsp;&nbsp;&nbsp;&nbsp;class.is.spring.ctrl](rules/class_is_spring_ctrl.md)
    ...
    * [&nbsp;&nbsp;&nbsp;&nbsp;endpoint.prefix.path](rules/endpoint_prefix_path.md)
    ...
    * [&nbsp;&nbsp;&nbsp;&nbsp;field.type](rules/field_type.md)
    * [&nbsp;&nbsp;&nbsp;&nbsp;folder.name](rules/folder_name.md)
    * [&nbsp;&nbsp;&nbsp;&nbsp;ignore](rules/ignore.md)
    * [&nbsp;&nbsp;&nbsp;&nbsp;json.additional.field](rules/json_additional_field.md)
    ...
    * [&nbsp;&nbsp;&nbsp;&nbsp;mdoc.method.filter](rules/mdoc_method_filter.md)
    ...
    * [&nbsp;&nbsp;&nbsp;&nbsp;method.additional.response.header](rules/method_additional_response_header.md)
    ...
    * [&nbsp;&nbsp;&nbsp;&nbsp;param.type](rules/param_type.md)
    ...
    * [&nbsp;&nbsp;&nbsp;&nbsp;properties.prefix](rules/properties_prefix.md)
* [支持的回调](config-rule.md#支持的回调)
    ...
    * [&nbsp;&nbsp;&nbsp;&nbsp;json.method.parse.before](events/json_method_parse_before.md)
    * [&nbsp;&nbsp;&nbsp;&nbsp;json.method.parse.after](events/json_method_parse_after.md)
